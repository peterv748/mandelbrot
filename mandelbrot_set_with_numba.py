...
spec = [('min_x', float64),('max_x',float64),('min_y', float64),('max_y', float64),('size_x',int64),('size_y',int64),('max_iterations',int64)]
@jitclass(spec)
class Mandelbrot():
...
def plot_mandelbrot(min_x, max_x, min_y, max_y, Z_temp, dt):
    ...
    plt.xlabel("Re(c), optimization using numba jit compiler time: %f s" % dt)
