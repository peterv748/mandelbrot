...
class Mandelbrot():    
        ...
        def Mandelbrot_set_plot(self, Ztemp, dt):
               ...
               matplotlib.axes.Axes.xlabel("Re(c), using numba jit compiler time: %f s" % dt)
               matplotlib.axes.Axes.ylabel("Im(c), max iter =300")
               matplotlib.axes.Axes.title( "mandelbrot set, image size (x,y): 4096 x 4096 pixels")
